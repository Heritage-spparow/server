...
if (useCluster && cluster.isMaster) {
  ...
  const baseOrigins = ['http://localhost:5173', 'http://localhost:3000', 'http://[::1]:3000', 'http://127.0.0.1:3000', 'http://localhost:5174', 'http://[::1]:5173',
    'https://heritage-spparow-client-git-main-ayushdev-a1s-projects.vercel.app', 'https://heritage-spparow-client.vercel.app', "https://admin-panel-mu-ten.vercel.app"];
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        connectSrc: ["'self'", "http://localhost:3000", "http://localhost:5173", "http://localhost:5174/",
          "https://heritage-spparow-client.vercel.app" ,"https://admin-panel-mu-ten.vercel.app"],
      },
    },
  }));
